...
export EXP_NAME="nov23_2enc_ft50k_4enc_1iter_freezenone_0grad_lr1e-5_sups0_random"
...
torchrun \
    ...
    training.resume_ckpt="./results/nov9_2enc_baseline/ckpt_0000000000050000.pt" \
