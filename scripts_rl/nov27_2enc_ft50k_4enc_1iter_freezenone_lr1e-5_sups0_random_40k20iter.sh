...
export EXP_NAME="nov27_2enc_ft50k_4enc_1iter_freezenone_lr1e-5_sups0_random_40k20iter"
...
torchrun \
    ...
    training.resume_ckpt="./results/nov23_2enc_ft50k_4enc_1iter_freezenone_lr1e-5_sups0_random/ckpt_0000000000040000.pt" \
