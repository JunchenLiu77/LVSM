...
export EXP_NAME="nov27_4enc_ft50k_1iter_freezenone_lr1e-5_sups0_random_clip4_40k20iter"
...
torchrun \
    ...
    model.ttt.supervise_s0=true \
    model.ttt.random_iter_supervision=true \
    training.test_1enc1ss=true \
    training.test_layers=[1,5,10,20] \
    training.resume_ckpt="./results/nov24_4enc_ft50k_1iter_freezenone_lr1e-5_sups0_random_clip4/ckpt_0000000000040000.pt" \
